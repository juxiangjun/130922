...
public class UtilTelephone {
	 ...
	 */
	public static boolean switchPrefix = true;
	 ...
	 * @Description:若开启前缀开关，会有"HiLauncherM_"前缀 如 HiLauncherM_milestone
	 *                                         否则为milestone<br>
	 *                                         判断机型时候，建议使用 contains 方法比对<br>
	 * @return String
	 * @throws
	 * @Modify date 2013-2-21 下午2:50:39
	 */
	public static String getMachineName() {
		 ...
		 */
		if (switchPrefix) {
			return CONST_STRING_PREFIX_MAC + android.os.Build.MODEL;
		} else {
	...
	/**
	 * <br>
	 * Description:获取versionName <br>
	 * Author:caizp <br>
	 * Date:2011-5-13下午01:43:16
	 * 
	 * @param context
	 * @param packageName
	 * @return
	 ...
	 * Log显示手机基本信息 <br>
	 * Author:ryan <br>
	 * Date:2012-8-13下午08:48:47
	 */
	public static void logPhoneState(Context ctx) {
		Log.i(TAG, "MachineName:" + UtilTelephone.getMachineName());
		Log.i(TAG, "Resolution WxH:" + UtilScreen.getInstance(ctx).getScreenWH()[0] + ":" + UtilScreen.getInstance(ctx).getScreenWH()[1]);
		Log.i(TAG, "Densit:" + UtilScreen.getInstance(ctx).getDensity());
		Log.i(TAG, "DensityDpi:" + UtilScreen.getInstance(ctx).getMetrics().densityDpi);
	}
	...
	public static String getNT(Context ctx) {
		...
		String nt = "0";
		if (UtilTelephone.isWifiEnable(ctx)) {
			nt = "10";
		} else if (imsi == null) {
			nt = "0";
