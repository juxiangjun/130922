package com.dyt.lpclub.activity.view.util;
...
public class AnimationController {
	...
	private class MyAnimationListener implements AnimationListener {
		...
		public MyAnimationListener(View view, boolean isback) {
			this.view = view;
			this.isback = isback;
		}
	...
	private void baseIn(View view, Animation animation, long durationMillis, long delayMillis, boolean isback) {
	...
	private void baseOut(View view, Animation animation, long durationMillis, long delayMillis, boolean isback) {
		setEffect(animation, Default, durationMillis, delayMillis);
		animation.setAnimationListener(new MyAnimationListener(view, isback));
		view.startAnimation(animation);
	}
	...
	public void fadeIn(View view, long durationMillis, long delayMillis) {
		...
		baseIn(view, animation, durationMillis, delayMillis, false);
	}

	public void fadeOut(View view, long durationMillis, long delayMillis) {
		AlphaAnimation animation = new AlphaAnimation(1, 0);
		baseOut(view, animation, durationMillis, delayMillis, false);
	}
	...
	public void slideInBack(View view, long durationMillis, long delayMillis) {
		TranslateAnimation animation = new TranslateAnimation(rela2, 0, rela2, 1, rela2, 0, rela2, 0);
		baseIn(view, animation, durationMillis, delayMillis, true);
	}
	...
	public void slideOutBack(View view, long durationMillis, long delayMillis) {
		TranslateAnimation animation = new TranslateAnimation(rela2, -1, rela2, 0, rela2, 0, rela2, 0);
		baseIn(view, animation, durationMillis, delayMillis, false);
	}
