...
public class PullToRefreshListView extends ListView implements OnScrollListener {
	...
	private void init(Context context) {
		...
		mRefreshFooterViewProgress =(ProgressBar) mInflater.inflate(R.layout.pull_to_refresh_footer, this, false);
		...
		addFooterView(mRefreshFooterViewProgress);
	...
	public void onScrollStateChanged(AbsListView view, int scrollState) {
		...
		if (mCurrentScrollState == SCROLL_STATE_IDLE) {
			...
			if (mOnRefreshListener != null) {
				mOnRefreshListener.onScrollStateIdle();
			}
		}
...
//			setSelection(1);
	...
	public void setFooterVisibility(int visibility){
		mRefreshFooterViewProgress.setVisibility(visibility);
	}

	public boolean isLastItem(int count){
	...
	public void setRefreshViewTextVisibility(int visibility){
		mRefreshViewText.setVisibility(visibility);
	}
}
